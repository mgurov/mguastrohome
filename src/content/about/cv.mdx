...
Informal **liaison and advocate** between feature and platform / DX teams. Transition from Oracle-backed monoliths to Java and Kotlin microservices. From on-premise to cloud (GCP). Created popular dev tools (internal with Go and React). [Public speaking](https://mgurov.github.io/talks/) at conferences and podcasts. 
