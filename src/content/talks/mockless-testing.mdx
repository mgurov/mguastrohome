...
I believe, the mock-infestation of tests is one of the major causes many are sceptical about the power of developer tests. 
...
Not to say we should ban mocks, I'll offer a decision framework for when they are OK, and when it's better to avoid using mocks in tests, and what are alternatives. 
...
Video from Devoxx Poland 2019: Automated tests: You won't find it in a book! - Jacek Milewski 
<YoutubeLink v="PQe8VruXipc" />
