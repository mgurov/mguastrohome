...
Thorough testing before merging to master is still important, but it's assumption-based. 
...
Why not just learn from the only true environment by conducting safe and efficient experiments?
